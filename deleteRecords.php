...
<head>
<meta charset="utf-8">
<title>Delete Students Records</title>
...
<div class="panel-heading">
  <h2 class="text-center">Delete Students Records</h2>
  </div>
...
<td><button class="btn btn-danger" name='delete' id="delete"><a href='deleteRecords.php?delete=<?php echo $id; ?>'id="delete" style="color:white;">Delete</a></button></td>
<?php } ?>        
      </tr>
         <?php
                    $counter++;
            ...
            if (isset($_GET['delete'])) {
                ...
                if ($result) {
                    ...
                    echo "<script>window.open('deleteRecords.php', '_self')</script>";
                } else {
                    echo "<script>alert('Student Can't be deleted!!')</script>";
                }
            }
            ?>
</tbody>
