...
<h4 class="text-left">User Login</h4>
</div>
...
<a href="counselorlogin.php">Counselor</a>
</div>
...
if (isset($_POST['submit'])) {
    ...
    $query = "SELECT * FROM userdetails WHERE username= '$username' && password= '$password' && userType = 2 && status='Accepted'";
