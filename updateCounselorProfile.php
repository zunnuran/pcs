...
<head>
<meta charset="utf-8">
<title>Counselor Profile Update</title>
...
<div class="panel-heading">
  <h2 class="text-center">Update Counselor Profile</h2>
  </div>
...
<td><button class="btn btn-info" name='update' id="update"><a style="color:white;" href='updateConsProfile.php?update=<?php echo $id; ?>'id="update">Update</a></button></td>
<?php } ?>        
      </tr>
         <?php
                    $counter++;
